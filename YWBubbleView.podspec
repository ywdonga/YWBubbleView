#
#  Be sure to run `pod spec lint YWBubbleView.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  一个快速创建悬浮气泡的组件，可以设置级别放置于Alert上层
                   DESC

  spec.homepage     = "https://github.com/ywdonga/YWBubbleView"
  ...
  spec.source       = { :git => "https://github.com/ywdonga/YWBubbleView.git", :tag => "#{spec.version}" }
